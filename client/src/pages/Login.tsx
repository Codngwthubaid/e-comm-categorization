  ...
  return (
    <div className="min-h-[calc(100vh-150px)] flex items-center justify-center bg-white">
      <div className="w-full max-w-md rounded-lg border p-8 shadow-sm">
        ...
        <p className="text-center text-gray-600 mb-6">Welcome back to ECOMMERCE<br />The next gen business marketplace</p>
        ...
        <div className="space-y-4">
          ...
          <p className="text-center text-sm text-gray-600">
            Don’t have an Account? <a href="/register" className="font-medium text-black">SIGN UP</a>
          </p>
        </div>
      </div>
    </div>
